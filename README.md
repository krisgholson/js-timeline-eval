Online reviews of timelines and gantt charts
...
Ones that look promising and that I want to fully evaluate

http://almende.github.io/chap-links-library/timeline.html and https://github.com/almende/chap-links-library
Already available on our network (though an old version) - just enough functionality - needs some better styling.
